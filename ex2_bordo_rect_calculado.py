...
if __name__ == "__main__":
    ...
    # Notas:
    # - β calculado conforme Eq. (6.44) e (6.45) do EC2
    # - k interpolado do Quadro 6.1 em função de c1/c2
    # - momentos aplicados M_Edx / M_Edy criam excentricidades
    ...
    v = PuncoamentoEC2(
        ...
        M_Edx=30_000, M_Edy=60_000,     # Nm (30 e 60 kN·m)
        sigma_cp=0.0,
        is_sapata=False, sigma_gd_kpa=0.0,
        u1_ineffective=0.0,
        beta_mode='calculado',
        laje_As_lx_cm2pm=9.50,
        laje_As_ly_cm2pm=9.50
    )
